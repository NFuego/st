...
// MARK: -
//
///// The View Controller for the AppointProfile module
//class AppointProfileViewController: UIViewController {
//
//	// MARK: - Constants
//
//	let presenter: AppointProfileViewPresenterProtocol
//
//
//	// MARK: Variables
//
...
//	// MARK: Inits
//
//	init(presenter: AppointProfileViewPresenterProtocol) {
...
protocol AppointProfilePresenterViewProtocol: class {
...
// MARK: - AppointProfile Presenter to View Protocol
extension AppointProfileViewController: AppointProfilePresenterViewProtocol {
...
public class AppointProfileViewController: UIViewController , GlobalUI {
...
extension AppointProfileViewController {
...
extension AppointProfileViewController : CarouselViewDataSourse {
...
//        let imageView = ToucheableImgView()
        ...
        imageView.kf.setImage(with: url, options: [.transition(.fade(0.2))], progressBlock: {
            receivedsize, totalsize in
            let percentage = (Float(receivedsize) / Float(totalsize)) * 100.0
            print("downloading progress: \(percentage)%")
            //            myindicator.percentage = percentage
...
extension AppointProfileViewController : CarouselViewDelegate {
    public func carousel(_ carousel: CarouselView, didTapAt cell: Int) {
        print(cell)
       let p = self.petsViews[cell]
        print(p)
//        MDApp.appointment.initVC?.dismiss(animated: true, completion: {
//            
//        })
        MDApp.appointment.petInfo = p
