...
class CustomerDayViewController: UIViewController, GlobalUI {
...
//
        ...
        // list
        let title = NSLocalizedString("今日行事曆", comment: "")
        self.title = title
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        MDApp
            .api
            .request(.ListMemos(id: 2, start: nowStr, end: nowStr)) // TODO true val
            .subscribe { (event) in
                switch event {
...
// MARK: - helper
extension CustomerDayViewController {
    func addMemoItem(){
